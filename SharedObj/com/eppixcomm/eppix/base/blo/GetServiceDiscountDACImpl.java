...
public class GetServiceDiscountDACImpl  extends DAC implements GetServiceDiscountDAC {
	// Globals
		private static DAOThrower thrower = DAOThrower
				.getDAOThrower(GetServiceDiscountDACImpl.class);
		private Logger logger = thrower.getLogger();

		public GetServiceDiscountDACImpl(DAOThrower thrower, DAO dao) {
			super(dao, thrower);
		}
		
		public GetServiceDiscountDACImpl(DAO dao) {
			super(dao, thrower);
		}

		public BigDecimal percDiscount1E(Date endDate, String packageCode,
				Integer SubscriberId, String interTariff, String serviceCode) throws EPPIXSeriousException {
			
			
			DAOParamQueryArgs args = new DAOParamQueryArgs(
					"percDiscount1E", 5);
			args.andFilterBy("percDiscount1E").arg(endDate).arg(packageCode).arg(SubscriberId).arg(interTariff).arg(serviceCode);
			StringDMO sumCharges = (StringDMO) dao.get("percDiscount1E", args);
		...
		public BigDecimal percDiscount2E(Date endDate, String packageCode,
				Integer SubscriberId, String interTariff, String serviceCode) throws EPPIXSeriousException {
			DAOParamQueryArgs args = new DAOParamQueryArgs(
					"percDiscount2E", 5);
			args.andFilterBy("percDiscount2E").arg(endDate).arg(packageCode).arg(SubscriberId).arg(interTariff).arg(serviceCode);
			StringDMO sumCharges = (StringDMO) dao.get("percDiscount2E", args);
		...
		public BigDecimal percDiscount3E(Date endDate, String packageCode,
				Integer SubscriberId, String interTariff, String serviceCode) throws EPPIXSeriousException {
			DAOParamQueryArgs args = new DAOParamQueryArgs(
					"percDiscount3E", 5);
			args.andFilterBy("percDiscount3E").arg(endDate).arg(packageCode).arg(SubscriberId).arg(interTariff).arg(serviceCode);
			StringDMO sumCharges = (StringDMO) dao.get("percDiscount3E", args);
		...
		public BigDecimal fixedDiscount1E(DateTime endDate, String packageCode,
				Integer SubscriberId, String interTariff, String serviceCode) throws EPPIXSeriousException {
			DAOParamQueryArgs args = new DAOParamQueryArgs(
					"fixedDiscount1E", 5);
			args.andFilterBy("fixedDiscount1E").arg(endDate).arg(packageCode).arg(SubscriberId).arg(interTariff).arg(serviceCode);
			StringDMO sumCharges = (StringDMO) dao.get("fixedDiscount1E", args);
		...
		public BigDecimal fixedDiscount1(DateTime endDate, String packageCode,
				String interTariff, String serviceCode)
				throws EPPIXSeriousException {
			DAOParamQueryArgs args = new DAOParamQueryArgs(
					"fixedDiscount1", 4);
		...
		public BigDecimal fixedDiscount2E(DateTime endDate, String packageCode,
				Integer SubscriberId, String interTariff, String serviceCode) throws EPPIXSeriousException {
			DAOParamQueryArgs args = new DAOParamQueryArgs(
					"fixedDiscount2E", 5);
			args.andFilterBy("fixedDiscount2E").arg(endDate).arg(packageCode).arg(SubscriberId).arg(interTariff).arg(serviceCode);
			StringDMO sumCharges = (StringDMO) dao.get("fixedDiscount2E", args);
		...
		public BigDecimal fixedDiscount2(DateTime endDate, String packageCode,
				String interTariff, String serviceCode)
				throws EPPIXSeriousException {
			DAOParamQueryArgs args = new DAOParamQueryArgs(
					"fixedDiscount2", 4);
		...
		public BigDecimal fixedDiscount3E(DateTime endDate, String packageCode,
				Integer SubscriberId, String interTariff, String serviceCode) throws EPPIXSeriousException {
			DAOParamQueryArgs args = new DAOParamQueryArgs(
					"fixedDiscount3E", 5);
			args.andFilterBy("fixedDiscount3E").arg(endDate).arg(packageCode).arg(SubscriberId).arg(interTariff).arg(serviceCode);
			StringDMO sumCharges = (StringDMO) dao.get("fixedDiscount3E", args);
		...
		public BigDecimal fixedDiscount3(DateTime endDate, String packageCode,
				String interTariff, String serviceCode)
				throws EPPIXSeriousException {
			DAOParamQueryArgs args = new DAOParamQueryArgs(
					"fixedDiscount3", 4);
