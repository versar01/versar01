 ...
 * @since $jdk$
 */
public interface MshMsisdnHistoryAbstractDAC {
  //~ Methods ////////////////////////////////////////////////////////////////

  /**
   * Creates the MshMsisdnHistory object in the database.
   *
   * @param MshMsisdnHistoryDMO mshMsisdnHistoryDMO
   *
   ...
   *
   * @param aMshMsisdnHistory MshMsisdnHistory object
   *
  ...
  /**
   * Modifies the MshMsisdnHistory object using the specified filter in the database.
   *
   * @param filter object
   *
   * @throws EPPIXSeriousException
   ...
   * @param locationDMO MshMsisdnHistory Data Model Object
   *
