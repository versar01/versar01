 ...
 * @since $jdk$
 */
public interface SbhSubHistoryAbstractDAC {
  //~ Methods ////////////////////////////////////////////////////////////////

  /**
   * Creates the SbhSubHistory object in the database.
   *
   * @param SbhSubHistoryDMO sbhSubHistoryDMO
   *
   ...
   *
   * @param aSbhSubHistory SbhSubHistory object
   *
  ...
  /**
   * Modifies the SbhSubHistory object using the specified filter in the database.
   *
   * @param filter object
   *
   * @throws EPPIXSeriousException
   ...
   * @param locationDMO SbhSubHistory Data Model Object
   *
