 ...
 * @since $jdk$
 */
public interface DisDiscountAbstractDAC {
  //~ Methods ////////////////////////////////////////////////////////////////
   ...
   *
   * @param DisDiscountDMO disDiscountDMO
   *
   * @throws EPPIXSeriousException
   */
   ...
   *
   * @param aDisDiscount DisDiscount object
   *
   ...
   *
   * @param disDiscountDMO DisDiscount object
   *
   * @throws EPPIXSeriousException
  ...
  /**
   * Modifies the DisDiscount object using the specified filter in the database.
   *
   * @param filter object
   *
   * @throws EPPIXSeriousException
  ...
  */
   ...
   * @param locationDMO DisDiscount Data Model Object
   *
