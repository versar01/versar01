 ...
 * @since $jdk$
 */
public interface DipDiscountPlanAbstractDAC {
  //~ Methods ////////////////////////////////////////////////////////////////

  /**
   * Retrieves a DipDiscountPlan Data Model Object
   *
   * @return a populated DipDiscountPlan Data Model Object or null if not found.
   *
   ...
   *
   * @param DipDiscountPlanDMO dipDiscountPlanDMO
   *
   * @throws EPPIXSeriousException
   */
   ...
   *
   * @param aDipDiscountPlan DipDiscountPlan object
   *
   ...
   *
   * @param dipDiscountPlanDMO DipDiscountPlan object
   *
   * @throws EPPIXSeriousException
  ...
  /**
   * Modifies the DipDiscountPlan object using the specified filter in the database.
   *
   * @param filter object
   *
   * @throws EPPIXSeriousException
  ...
  */
   ...
   * @param locationDMO DipDiscountPlan Data Model Object
   *
