...
//---------------------
/**
 * A value object to carry the data for an AsMessage.
 *
 *
 * <H3> An AsMessage is: </H3>
 *
 * <!-- indent text -->
 ...
 *     It is used to pass the data for an asMessage into and out of the BASE module.
 *     Because it's purpose is to carry data into and out of the module it is visible outside the module.
 * </P>
 * <P>
 *     This value object carries the data for one asMessage. An asMessage is:
 * Holds all messages used throughout VAS.
 * </P>
 * <P>
 *     It corresponds to the business logic object AsMessage which
 *     contains all the business behaviour of an asMessage but is not visible outside the
 *     BASE module.
 * </P>
 * <P>
 ...
 *
 * <P>
 *    This value object contains fields for all the details of an asMessage, namely:
 * </P>
 *


 * <P>
 *    <U>Fields to carry the Attributes of an asMessage:</U>
 * </P>
 *
 * <!-- indent text -->
 * <TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
 ...
 *   </TD>
 *   <TD ALIGN="left" VALIGN="top"><B>mcode</B></TD>
 ...
 *       <img src="file://C:/Eppix/Eppixgen/icons/publicMethod.gif" alt="public method" title="public method" align="center" />
 *       <A HREF="#setMcode(java.lang.Integer)">
 *           setMcode (Integer)
 *       </A>
 *     </P>
 *   </TD>
 ...
 *       <img src="file://C:/Eppix/Eppixgen/icons/privateAttribute.gif" alt="private attribute" title="private attribute" align="center" />
 *   </TD>
 *   <TD ALIGN="left" VALIGN="top"><B>mmess</B></TD>
 ...
 *       <!-- link to the anchor of the attribute's setter method. It has the logical visibility specified for the attribute -->
 *       <img src="file://C:/Eppix/Eppixgen/icons/publicMethod.gif" alt="public method" title="public method" align="center" />
 *       <A HREF="#setMmess(java.lang.String)">
 *           setMmess (String)
 *       </A>
 *     </P>
 *   </TD>
...
public class AsMessageDMO
  ...
  private static final int[] fieldTypes = new int[] {
      FIELD_TYPE_INTEGER /* std public attribute: mcode  */,
      FIELD_TYPE_STRING /* std public attribute: mmess  */
    };

  /** Unique field index used for Filtering. @see com.eppixcomm.eppix.common.util.QueryFilter */
  public static final int mcodeFilter = 0; // filter index

  /** Unique field index used for Filtering. @see com.eppixcomm.eppix.common.util.QueryFilter */
  public static final int mmessFilter = 1; // filter index
  private static final int mmessSize = 76; // field size
  ...
  //---------------------
  // all attributes
  private Integer mcode; // Loaded from Schema
  private String mmess; // Loaded from Schema

  //~ Constructors ///////////////////////////////////////////////////////////

  /**
   * Creates a new AsMessageDMO object.
   */
  public AsMessageDMO(  ) {
  }
   ...
   * Creates a new AsMessageDMO object.
   *
   * @param mcode DOCUMENT ME!
   * @param mmess DOCUMENT ME!
   */
  public AsMessageDMO( 
    final Integer mcode,
    final String  mmess ) {
  ...
  protected DAOArgs primaryKey(  ) {
    return new DAOArgs( 1 ).arg( this.mcode );
  }
 ...
 private final int[] fieldSizes = new int[] {
  ...
  protected Object[] get(  ) {
    return new Object[] {
      mcode,
      ( mmess == null ) ? null
                        : ( ( mmess.length(  ) <= mmessSize ) ? mmess
                                                              : mmess
      .substring( 0, mmessSize ) // auto trimmed to fit, if required.
       )
    };
  }
  ...
  protected void set( final Object[] fields ) {
    mcode = (Integer) fields[0];
    mmess = rtrim( (String) fields[1] );
  }
  ...
  /**
  * Sets the Mcode field.
  *
  * @param mcode
  */
  public void setMcode( final Integer mcode ) {
    this.mcode = mcode;
  }

  /**
  * Sets the Mmess field.
  *
  * @param mmess
  */
  public void setMmess( final String mmess ) {
    this.mmess = getPadded(mmess, mmessFilter);
  }
