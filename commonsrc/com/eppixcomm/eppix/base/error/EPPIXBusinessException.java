...
/**
 * This exception is thrown by an EPPIX module when a business rule has been
 * violated.
 *
 ...
 * @since $jdk$
 */
public class EPPIXBusinessException
  extends EPPIXNonFatalException {
    
  /**
   * Constructs a new exception with null as its detail message.
   */
  public EPPIXBusinessException() {
    super();
  }
   ...
   * @param message
   */
  public EPPIXBusinessException(Message message) {
    super(message);
  }
   ...
   * @param messageArg
   */
  public EPPIXBusinessException(Message message, Object messageArg) {
   ...
   * @param messageArgs
   */
  public EPPIXBusinessException(Message message, Object[] messageArgs) {
   ...
   * @param cause
   */
  public EPPIXBusinessException(Message message, Throwable cause) {
    super(message, cause);
  }
   ...
   */
  public EPPIXBusinessException( String message ) {
    super( message );
  }
   ...
   * @param cause the cause.
   */
  public EPPIXBusinessException( Throwable cause ) {
    super( cause );
  }
   ...
   * @param message the detail message.
   */
  public EPPIXBusinessException( String errorCode,
                                 String message ) {
