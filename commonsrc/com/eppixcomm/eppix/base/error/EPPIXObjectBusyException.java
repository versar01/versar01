...
/**
 * This exception is thrown by an EPPIX module when a lock could not be
 * obtained on an object because it was locked by another process.
 *
 * @version $Revision: 1.1 $
 * @author $Author$
 * @since $jdk$
 */
public class EPPIXObjectBusyException
  extends EPPIXUnexpectedException {
  /**
   * Constructs a new exception with null as its detail message.
   */
  public EPPIXObjectBusyException() {
    super();
  }
   ...
   */
  public EPPIXObjectBusyException( String message ) {
    super( message );
  }
   ...
   * @param cause the cause.
   */
  public EPPIXObjectBusyException( Throwable cause ) {
    super( cause );
  }
   ...
   * @param message the detail message.
   */
  public EPPIXObjectBusyException( String errorCode,
                                   String message ) {
