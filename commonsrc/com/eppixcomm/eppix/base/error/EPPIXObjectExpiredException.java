...
/**
 * This exception is thrown by an EPPIX module when the database contains a
 * newer version of an object being considered for update. The version of
 ...
 * @since $jdk$
 */
public class EPPIXObjectExpiredException
  extends EPPIXUnexpectedException {
  /**
   * Constructs a new exception with null as its detail message.
   */
  public EPPIXObjectExpiredException() {
    super();
  }
   ...
   */
  public EPPIXObjectExpiredException( String message ) {
    super( message );
  }
   ...
   * @param cause the cause.
   */
  public EPPIXObjectExpiredException( Throwable cause ) {
    super( cause );
  }
   ...
   * @param message the detail message.
   */
  public EPPIXObjectExpiredException( String errorCode,
                                      String message ) {
