 ...
 * @since $jdk$
 */
public class EPPIXSeriousException
  extends EPPIXUnexpectedException {
  /**
   * Constructs a new exception with null as its detail message.
   */
  public EPPIXSeriousException() {
    super();
  }
   ...
   * @param message
   */
  public EPPIXSeriousException(Message message) {
    super(message);
  }
   ...
   * @param messageArg
   */
  public EPPIXSeriousException(Message message, Object messageArg) {
   ...
   * @param messageArgs
   */
  public EPPIXSeriousException(Message message, Object[] messageArgs) {
   ...
   * @param cause
   */
  public EPPIXSeriousException(Message message, Throwable cause) {
    super(message, cause);
  }
   ...
   */
  public EPPIXSeriousException( String message ) {
    super( message );
  }
   ...
   * @param cause the cause.
   */
  public EPPIXSeriousException( Throwable cause ) {
    super( cause );
  }
   ...
   * @param message the detail message.
   */
  public EPPIXSeriousException( String errorCode,
                                       String message ) {
