...
/**
 * This exception is thrown by an EPPIX module when an object was
 * unexpectedly not be found in the database.
 *
 * @version $Revision: 1.1 $
 * @author $Author$
 * @since $jdk$
 */
public class EPPIXObjectNotFoundException
  extends EPPIXUnexpectedException {
  /**
   * Constructs a new exception with null as its detail message.
   */
  public EPPIXObjectNotFoundException() {
    super();
  }
   ...
   */
  public EPPIXObjectNotFoundException( String message ) {
    super( message );
  }
   ...
   * @param cause the cause.
   */
  public EPPIXObjectNotFoundException( Throwable cause ) {
    super( cause );
  }
   ...
   * @param message the detail message.
   */
  public EPPIXObjectNotFoundException( String errorCode,
                                       String message ) {
