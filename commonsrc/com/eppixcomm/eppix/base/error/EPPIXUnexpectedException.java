 ...
 * condition occurs that does not prevent the system from functioning. The
 * application is likely to be able to process other method calls.
 *
 * @version $Revision: 1.1 $
 * @author $Author$
 * @since $jdk$
 */
abstract public class EPPIXUnexpectedException
  extends EPPIXNonFatalException {
  /**
   * Constructs a new exception with null as its detail message.
   */
  public EPPIXUnexpectedException() {
    super();
  }
   ...
   * @param message
   */
  public EPPIXUnexpectedException(Message message) {
    super(message);
  }
   ...
   * @param messageArg
   */
  public EPPIXUnexpectedException(Message message, Object messageArg) {
   ...
   * @param messageArgs
   */
  public EPPIXUnexpectedException(Message message, Object[] messageArgs) {
   ...
   * @param cause
   */
  public EPPIXUnexpectedException(Message message, Throwable cause) {
    super(message, cause);
  }
   ...
   */
  public EPPIXUnexpectedException( String message ) {
    super( message );
  }
   ...
   * @param cause the cause.
   */
  public EPPIXUnexpectedException( Throwable cause ) {
    super( cause );
  }
   ...
   * @param message the detail message.
   */
  public EPPIXUnexpectedException( String errorCode,
                                   String message ) {
