...
public class Format {
  ...
  * malformed.
  */
  public Format(String fmtArg) throws IllegalArgumentException {
  ...
  * malformed.
  */
  public Format(Locale locale, String fmtArg) throws IllegalArgumentException {
  ...
  public static String format(String format, Object[] params) {
    return new Format(format).sprintf(params);
  }
  ...
  */
  private class ConversionSpecification {
    ...
    String internalsprintf(int s) throws IllegalArgumentException {
      ...
      default:
        throw new IllegalArgumentException(
            "Cannot format a int with a format using a " + conversionCharacter
    ...
    String internalsprintf(double s) throws IllegalArgumentException {
      ...
      default:
        throw new IllegalArgumentException("Cannot "
            + "format a double with a format using a " + conversionCharacter
            + " conversion character.");
      }
      return s2;
    }
  ...
  public static void main(String[] args) {
    System.out.println(Format.format("%10s%06d%%", args));
  }
}
