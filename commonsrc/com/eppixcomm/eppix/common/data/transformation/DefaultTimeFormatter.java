 ...
 */
public class DefaultTimeFormatter implements TypeFormatter, Serializable {
  ...
  public String format( Object value ) throws Exception {
    ...
    return (value == null) ? "" : String.valueOf( ( (Time) value ).getTime(  ) );
  }
  ...
  public Object parse( String source ) throws Exception {
    ...
    return new Time( new Long( source ).longValue(  ) );
  }
}
