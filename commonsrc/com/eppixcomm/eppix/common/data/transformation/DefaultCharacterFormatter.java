 ...
 *
 */
public class DefaultCharacterFormatter implements TypeFormatter, Serializable {
  ...
  public String format( Object value ) throws Exception {
    ...
    return (value == null) ? "" : String.valueOf( (int) ( (Character) value ).charValue(  ) );
  }
  ...
  public Object parse( String source ) throws Exception {
    ...
    return new Character( (char) Integer.parseInt( source ) );
  }
}
