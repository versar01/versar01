...
public class AuxSlcustTarDQO extends DBO implements Serializable {
	...
	public static final int classFilter = 96;
	private static final int classSize = 6;
	...
	public AuxSlcustTarDQO() {
	};

	public AuxSlcustTarDQO(final String auxTitle, final String auxFirstname, final Integer auxInvoiceAddrid,
			...
			final BigDecimal creditLimit, final BigDecimal ytdSales, final BigDecimal ytdCostOfSales, final BigDecimal cumulativeSales,
			final BigDecimal orderBalance, final String salesNlCat, final String specialPrice, final String vatRegistration,
			final String directDebit, final String invoicesPrinted, final String consolidatedInv,
			final String commentOnlyInv, final String bankAccountNo, final String bankSortCode, final String bankname,
			final String bankAddress1, final String bankAddress2, final String bankAddress3, final String bankAddress4,
			final String analysisCode6, final String produceStatements, final String ediCustomer, final String vatType,
			final String language, final String deliveryMethod, final String carrier, final String vatRegNumber,
			final String vatExeNumber, final String paydays1, final String paydays2, final String paydays3,
			final String bankBranchCode, final String printCpWithStat, final String paymentMethod,
			final String customerClass, final String salesType, final BigDecimal cpLowerValue, final String address6,
			final String fax, final String telex, final String btx, final String cpCharge, final String controlDigit,
			final String payer, final String responsibility, final String despatchHeld, final String creditController,
	...
	private static final int[] fieldSizes = new int[] { auxTitleSize, auxFirstnameSize, 0, bankNameSize, bankAddr1Size,
			...
			currencySize, territorySize, classSize, regionSize, invoiceCustomerSize, statementCustomerSize,
			...
			tarOverrideSize, tarOverrideUserSize, tarUserIdSize, tarSystemReqSize };
	...
	private static final int[] fieldTypes = new int[] { FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_INTEGER,
			...
			FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING,
			FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING,
			FIELD_TYPE_BIGDECIMAL, FIELD_TYPE_BIGDECIMAL, FIELD_TYPE_BIGDECIMAL, FIELD_TYPE_BIGDECIMAL, FIELD_TYPE_BIGDECIMAL,
			FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING,
			FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING,
			FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING,
			FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING,
			...
			FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING,
			FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_INTEGER, FIELD_TYPE_INTEGER,
			FIELD_TYPE_INTEGER, FIELD_TYPE_INTEGER, FIELD_TYPE_INTEGER, FIELD_TYPE_INTEGER, FIELD_TYPE_STRING,
			FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING,
	...
	protected Object[] get() {
		return new Object[] {
				...
				((this.klass == null) ? null
						: (this.klass.length() <= classSize) ? this.klass : this.klass.substring(0, this.classSize)),
