...
public class TmpN2NSimServicesDQO extends DBO implements Serializable {
  ...
  private static final int internTariffSize = 20; // field size
  ...
  private static final int activateOrderSize = 14; // field size
  ...
  public TmpN2NSimServicesDQO() {
  }

  public TmpN2NSimServicesDQO(String serviceCode, String serviceType,
      String internTariff, String simNo, String msisdnNo, Integer rowid,
//      String netServCode, String supServCode, 
      String msisdnKnown,
