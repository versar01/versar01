...
public class VasVamVsmSubSimDQO extends DBO implements Serializable {
	...
	public VasVamVsmSubSimDQO() {
	};

	public VasVamVsmSubSimDQO(final Integer vasSubscriberId,
	...
	private static final int[] fieldSizes = new int[] { 0, vasServiceCodeSize,
			...
			vamSubsSuffixSize, vamMessCommentSize, vamAirtimeNetSize,
			vamPrFlagSize, vamHierarchySize, vamMsisdnKnownSize, 0,
			vamOrigProvIdSize, vamImpProvIdSize, vamOrigServProvSize,
			vamImpServProvSize, vamMsisdnTypeSize, vamDummySize, 0,
			vamExportedToSize, vamAnalysis1Size, vamAnalysis2Size,
			vamAnalysis3Size, vamAnalysis4Size, vamAnalysis5Size, 0,
			vsmServiceCodeSize, vsmMsisdnNoSize, 0, 0, 0, vsmNodeSentSize };
	...
	private static final int[] fieldTypes = new int[] { FIELD_TYPE_INTEGER,
			...
			FIELD_TYPE_DATE, FIELD_TYPE_DATE, FIELD_TYPE_STRING,
			FIELD_TYPE_DATE, FIELD_TYPE_SHORT, FIELD_TYPE_DATE,
			FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING,
	...
	protected void set(Object[] fields) {
		...
		this.vamConnectDate = ((fields[16] == null) ? null : new Date(
				fields[16]));
		this.vamDconnectDate = ((fields[17] == null) ? null : new Date(
				fields[17]));
		this.vamInternTariff = rtrim((String) fields[18]);
		this.vamContrTerminat = ((fields[19] == null) ? null : new Date(
				fields[19]));
		this.vamContrPeriod = ((Short) fields[20]);
		this.vamTerminatNotif = ((fields[21] == null) ? null : new Date(
				fields[21]));
		...
		this.vamMsisdnExprtd = ((fields[41] == null) ? null : new Date(
				fields[41]));
		...
		this.vsmActivateDate = ((fields[51] == null) ? null : new Date(
				fields[51]));
		this.vsmDeactDate = ((fields[52] == null) ? null : new Date(fields[52]));
		this.vsmBilledUpto = ((fields[53] == null) ? null
				: new Date(fields[53]));
	...
	public String toString() {
		return "\nVasVamVsmSubSimDQO [\nvasDMO=" + vasDMO + ", vamDMO=" + vamDMO
				+ ", vsmDMO=" + vsmDMO + ", vasSubscriberId=" + vasSubscriberId
				+ ", vasServiceCode=" + vasServiceCode + ", vasInternTariff="
				+ vasInternTariff + ", vasServiceType=" + vasServiceType
				+ ", vasActDate=" + vasActDate + ", vasDeactDate="
				+ vasDeactDate + ", vasSubCharge1=" + vasSubCharge1
				+ ", vasSubCharge2=" + vasSubCharge2 + ", vasSubCharge3="
				+ vasSubCharge3 + ", vasTwinbillNo=" + vasTwinbillNo
				+ ", vasMultiCharge=" + vasMultiCharge + ", vamSubscriberId="
				+ vamSubscriberId + ", vamSimNo=" + vamSimNo + ", vamMsisdnNo="
				+ vamMsisdnNo + ", vamTwinbillNo=" + vamTwinbillNo
				+ ", vamStatCode=" + vamStatCode + ", vamConnectDate="
				+ vamConnectDate + ", vamDconnectDate=" + vamDconnectDate
				+ ", vamInternTariff=" + vamInternTariff
				+ ", vamContrTerminat=" + vamContrTerminat
				+ ", vamContrPeriod=" + vamContrPeriod + ", vamTerminatNotif="
				+ vamTerminatNotif + ", vamDirEntry=" + vamDirEntry
				+ ", vamItemised=" + vamItemised + ", vamDepartment="
				+ vamDepartment + ", vamSalesman=" + vamSalesman
				+ ", vamDealerId=" + vamDealerId + ", vamAbarDate="
				+ vamAbarDate + ", vamSubsSuffix=" + vamSubsSuffix
				+ ", vamMessComment=" + vamMessComment + ", vamAirtimeNet="
				+ vamAirtimeNet + ", vamPrFlag=" + vamPrFlag
				+ ", vamHierarchy=" + vamHierarchy + ", vamMsisdnKnown="
				+ vamMsisdnKnown + ", vamTariffChg=" + vamTariffChg
				+ ", vamOrigProvId=" + vamOrigProvId + ", vamImpProvId="
				+ vamImpProvId + ", vamOrigServProv=" + vamOrigServProv
				+ ", vamImpServProv=" + vamImpServProv + ", vamMsisdnType="
				+ vamMsisdnType + ", vamDummy=" + vamDummy
				+ ", vamMsisdnExprtd=" + vamMsisdnExprtd + ", vamExportedTo="
				+ vamExportedTo + ", vamAnalysis1=" + vamAnalysis1
				+ ", vamAnalysis2=" + vamAnalysis2 + ", vamAnalysis3="
				+ vamAnalysis3 + ", vamAnalysis4=" + vamAnalysis4
				+ ", vamAnalysis5=" + vamAnalysis5 + ", vsmSubscriberId="
				+ vsmSubscriberId + ", vsmServiceCode=" + vsmServiceCode
				+ ", vsmMsisdnNo=" + vsmMsisdnNo + ", vsmActivateDate="
				+ vsmActivateDate + ", vsmDeactDate=" + vsmDeactDate
				+ ", vsmBilledUpto=" + vsmBilledUpto + ", vsmNodeSent="
				+ vsmNodeSent + "]";
	}
