...
import com.eppixcomm.eppix.base.blo.VamActiveMsisdnDAC;
...
public class VamVasVsrDQO extends DBO implements Serializable {
	...
	public VamVasVsrDQO(final Integer vamSubscriberId, final String vamSimNo,
	...
	private static final int[] fieldSizes = new int[] { 0, vamSimNoSize,
			...
			vsrProrataSize, vsrProviderIdSize, vsrShortDescSize, vsrSuspendSize };
	...
	protected void set(Object[] fields) {
		...
		this.vasActDate = ((fields[41] == null) ? null : new Date(
				 fields[41]));
		this.vasDeactDate = ((fields[42] == null) ? null : new Date(
				 fields[42]));
