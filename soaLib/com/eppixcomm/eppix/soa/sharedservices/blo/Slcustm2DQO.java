...
public class Slcustm2DQO  extends DBO implements Serializable {
	...
	private String paymentMethod; // - slcustm.payment_method
	...
	public static final int paymentMethodFilter = 12;
	private static final int paymentMethodSize = 2;

	public Slcustm2DQO() {
	};

	public Slcustm2DQO(final String customer, final String name, BigDecimal credtLimit, String analysisCodes1,
			...
			final String firstname, final String paymentMethod) {
	...
	private static final int[] fieldSizes = new int[] { customerSize, nameSize,0,analysisCodes1Filter,
			...
			groupCustomerSize, address5Size, surnameSize, 0, firstnameSize, paymentMethodSize };
		...
		return new Object[] {
				...
				((this.firstname == null) ? null
				 ...
				 ( paymentMethod == null ) ? null
                         : ( ( paymentMethod.length(  ) <= paymentMethodSize )? paymentMethod: paymentMethod.substring( 0, paymentMethodSize ) // auto trimmed to fit, if required.
)};
	}
	...
	protected void set(Object[] fields) {
		...
		this.paymentMethod = rtrim((String) fields[13]);
	}
