...
public class AuxSlcustmSbdDQO extends DBO implements Serializable {
...
private static final int sbdSubscriberIdSize = 11126983;
...
public AuxSlcustmSbdDQO(){};

public AuxSlcustmSbdDQO(final String auxTitle,
final String auxFirstname,
final Integer auxInvoiceAddrid,
final String bankName,
final String bankAddr1,
final String bankAddr2,
final String bankAcName,
final String ref,
final String bankScode,
final String bankAcNo,
final String bankAcType,
final String bankPayType,
final Short auxPrefDebitDay,
final String billAcNo,
final String protectCode,
final Integer handsetCt,
final Date bankDate,
final Date confDate,
final String auxComment,
final Date dateOfBirth,
final Date refPayDate,
final Date acClosDate,
final Date noReasDate,
final Date remLetDate,
final Date acTranDate,
final Date noAcDate,
final String srFlag,
final String processed,
final String packageCode,
final String auxAccountType,
final String auxBillCycle,
final String creditCardNo,
final String creditCardName,
final Date expiryDate,
final String auxCardCvvNo,
final Integer creditScore,
final Integer servProvId,
final String dealerId,
final String salesman,
final String idNumber,
final String accStatus,
final String compRegNo,
final String stationaryType,
final Integer maxNoSubs,
final String auxCurrency,
final String auxCountryCode,
final String auxGender,
final String auxSubGrpAccNo,
final String auxPrepaidStat,
final String auxCreditClass,
final String auxAutoLimitInd,
final Short auxLmtUpVal,
final Short auxLmtDnVal,
final String auxAnalysis1,
final String auxAnalysis2,
final String auxAnalysis3,
final String auxAnalysis4,
final String auxAnalysis5,
final String auxAnalysis6,
final String auxAnalysis7,
final String auxAnalysis8,
final String auxAnalysis9,
final String auxAnalysis10,
final String auxAnalysis11,
final String auxAnalysis12,
final String auxAnalysis13,
final String auxAnalysis14,
final String auxAnalysis15,
final String auxAnalysis16,
final String auxAnalysis17,
final String auxAnalysis18,
final String auxAnalysis19,
final String auxAnalysis20,
final String auxAnalysis21,
final String auxAnalysis22,
final String auxAnalysis23,
final String auxAnalysis24,
final String auxAnalysis25,
final String auxAnalysis26,
final String auxAnalysis27,
final String auxAnalysis28,
final String auxAnalysis29,
final String auxAnalysis30,
...
protected void deConstruct(){
	auxDMO = new AuxCustomersDMO(auxTitle, auxFirstname, auxInvoiceAddrid, bankName, bankAddr1, bankAddr2, bankAcName, ref, bankScode, bankAcNo, bankAcType, bankPayType, auxPrefDebitDay, billAcNo, protectCode, handsetCt, bankDate, confDate, auxComment, dateOfBirth, refPayDate, acClosDate, noReasDate, remLetDate, acTranDate, noAcDate, srFlag, processed, packageCode, auxAccountType, auxBillCycle, creditCardNo, creditCardName, expiryDate, auxCardCvvNo, creditScore, servProvId, dealerId, salesman, idNumber, accStatus, compRegNo, stationaryType, maxNoSubs, auxCurrency, auxCountryCode, auxGender, auxSubGrpAccNo, auxPrepaidStat, auxCreditClass, auxAutoLimitInd, auxLmtUpVal, auxLmtDnVal, auxAnalysis1, auxAnalysis2, auxAnalysis3, auxAnalysis4, auxAnalysis5, auxAnalysis6, auxAnalysis7, auxAnalysis8, auxAnalysis9, auxAnalysis10, auxAnalysis11, auxAnalysis12, auxAnalysis13, auxAnalysis14, auxAnalysis15, auxAnalysis16, auxAnalysis17, auxAnalysis18, auxAnalysis19, auxAnalysis20, auxAnalysis21, auxAnalysis22, auxAnalysis23, auxAnalysis24, auxAnalysis25, auxAnalysis26, auxAnalysis27, auxAnalysis28, auxAnalysis29, auxAnalysis30);
	
	slcustDMO = new SlcustmDMO(customer, alpha, auxFirstname, address1, address2, address3, address4, address5, creditCategory, exportIndicator, custDiscCode, auxCurrency, territory, klass, region, invoiceCustomer, statementCustomer, groupCustomer, dateLastIssue, dateCreated, analysisCodes1, analysisCodes2, analysisCodes3, analysisCodes4, analysisCodes5, reminderCat, settlementCode, settDaysCode, priceList, letterCode, balanceFwd, creditLimit, ytdSales, ytdCostOfSales, cumulativeSales, orderBalance, salesNlCat, specialPrice, vatRegistration, directDebit, invoicesPrinted, consolidatedInv, commentOnlyInv, bankAccountNo, bankSortCode, bankname, bankAddress1, bankAddress2, bankAddress3, bankAddress4, analysisCode6, produceStatements, ediCustomer, vatType, language, deliveryMethod, carrier, vatRegNumber, vatExeNumber, paydays1, paydays2, paydays3, bankBranchCode, printCpWithStat, paymentMethod, customerClass, salesType, cpLowerValue, address6, fax, telex, btx, cpCharge, controlDigit, payer, responsibility, despatchHeld, creditController, reminderLetters, severityDays1, severityDays2, severityDays3, severityDays4, severityDays5, severityDays6, deliveryReason, shipperCode1, shipperCode2, shipperCode3, shippingNoteInd, accountType, adminFee, intrestRate);
...
protected Object[] get() {
		return new Object[]{			((this.auxTitle == null) ? null : (this.auxTitle.length() <= auxTitleSize) ? this.auxTitle : this.auxTitle.substring(0, this.auxTitleSize)),
			((this.auxFirstname == null) ? null : (this.auxFirstname.length() <= auxFirstnameSize) ? this.auxFirstname : this.auxFirstname.substring(0, this.auxFirstnameSize)),
			...
			((this.bankAddr1 == null) ? null : (this.bankAddr1.length() <= bankAddr1Size) ? this.bankAddr1 : this.bankAddr1.substring(0, this.bankAddr1Size)),
			((this.bankAddr2 == null) ? null : (this.bankAddr2.length() <= bankAddr2Size) ? this.bankAddr2 : this.bankAddr2.substring(0, this.bankAddr2Size)),
			((this.bankAcName == null) ? null : (this.bankAcName.length() <= bankAcNameSize) ? this.bankAcName : this.bankAcName.substring(0, this.bankAcNameSize)),
			((this.ref == null) ? null : (this.ref.length() <= refSize) ? this.ref : this.ref.substring(0, this.refSize)),
			((this.bankScode == null) ? null : (this.bankScode.length() <= bankScodeSize) ? this.bankScode : this.bankScode.substring(0, this.bankScodeSize)),
			((this.bankAcNo == null) ? null : (this.bankAcNo.length() <= bankAcNoSize) ? this.bankAcNo : this.bankAcNo.substring(0, this.bankAcNoSize)),
			((this.bankAcType == null) ? null : (this.bankAcType.length() <= bankAcTypeSize) ? this.bankAcType : this.bankAcType.substring(0, this.bankAcTypeSize)),
			((this.bankPayType == null) ? null : (this.bankPayType.length() <= bankPayTypeSize) ? this.bankPayType : this.bankPayType.substring(0, this.bankPayTypeSize)),
			this.auxPrefDebitDay,
			((this.billAcNo == null) ? null : (this.billAcNo.length() <= billAcNoSize) ? this.billAcNo : this.billAcNo.substring(0, this.billAcNoSize)),
			((this.protectCode == null) ? null : (this.protectCode.length() <= protectCodeSize) ? this.protectCode : this.protectCode.substring(0, this.protectCodeSize)),
			this.handsetCt,
			this.bankDate,
			this.confDate,
			((this.auxComment == null) ? null : (this.auxComment.length() <= auxCommentSize) ? this.auxComment : this.auxComment.substring(0, this.auxCommentSize)),
			this.dateOfBirth,
			this.refPayDate,
			this.acClosDate,
			this.noReasDate,
			...
			this.acTranDate,
			this.noAcDate,
			((this.srFlag == null) ? null : (this.srFlag.length() <= srFlagSize) ? this.srFlag : this.srFlag.substring(0, this.srFlagSize)),
			((this.processed == null) ? null : (this.processed.length() <= processedSize) ? this.processed : this.processed.substring(0, this.processedSize)),
			((this.packageCode == null) ? null : (this.packageCode.length() <= packageCodeSize) ? this.packageCode : this.packageCode.substring(0, this.packageCodeSize)),
			((this.auxAccountType == null) ? null : (this.auxAccountType.length() <= auxAccountTypeSize) ? this.auxAccountType : this.auxAccountType.substring(0, this.auxAccountTypeSize)),
			((this.auxBillCycle == null) ? null : (this.auxBillCycle.length() <= auxBillCycleSize) ? this.auxBillCycle : this.auxBillCycle.substring(0, this.auxBillCycleSize)),
			((this.creditCardNo == null) ? null : (this.creditCardNo.length() <= creditCardNoSize) ? this.creditCardNo : this.creditCardNo.substring(0, this.creditCardNoSize)),
			((this.creditCardName == null) ? null : (this.creditCardName.length() <= creditCardNameSize) ? this.creditCardName : this.creditCardName.substring(0, this.creditCardNameSize)),
			this.expiryDate,
			((this.auxCardCvvNo == null) ? null : (this.auxCardCvvNo.length() <= auxCardCvvNoSize) ? this.auxCardCvvNo : this.auxCardCvvNo.substring(0, this.auxCardCvvNoSize)),
			this.creditScore,
			this.servProvId,
			((this.dealerId == null) ? null : (this.dealerId.length() <= dealerIdSize) ? this.dealerId : this.dealerId.substring(0, this.dealerIdSize)),
			((this.salesman == null) ? null : (this.salesman.length() <= salesmanSize) ? this.salesman : this.salesman.substring(0, this.salesmanSize)),
			((this.idNumber == null) ? null : (this.idNumber.length() <= idNumberSize) ? this.idNumber : this.idNumber.substring(0, this.idNumberSize)),
			((this.accStatus == null) ? null : (this.accStatus.length() <= accStatusSize) ? this.accStatus : this.accStatus.substring(0, this.accStatusSize)),
			((this.compRegNo == null) ? null : (this.compRegNo.length() <= compRegNoSize) ? this.compRegNo : this.compRegNo.substring(0, this.compRegNoSize)),
			((this.stationaryType == null) ? null : (this.stationaryType.length() <= stationaryTypeSize) ? this.stationaryType : this.stationaryType.substring(0, this.stationaryTypeSize)),
			this.maxNoSubs,
			((this.auxCurrency == null) ? null : (this.auxCurrency.length() <= auxCurrencySize) ? this.auxCurrency : this.auxCurrency.substring(0, this.auxCurrencySize)),
			((this.auxCountryCode == null) ? null : (this.auxCountryCode.length() <= auxCountryCodeSize) ? this.auxCountryCode : this.auxCountryCode.substring(0, this.auxCountryCodeSize)),
			((this.auxGender == null) ? null : (this.auxGender.length() <= auxGenderSize) ? this.auxGender : this.auxGender.substring(0, this.auxGenderSize)),
			((this.auxSubGrpAccNo == null) ? null : (this.auxSubGrpAccNo.length() <= auxSubGrpAccNoSize) ? this.auxSubGrpAccNo : this.auxSubGrpAccNo.substring(0, this.auxSubGrpAccNoSize)),
			((this.auxPrepaidStat == null) ? null : (this.auxPrepaidStat.length() <= auxPrepaidStatSize) ? this.auxPrepaidStat : this.auxPrepaidStat.substring(0, this.auxPrepaidStatSize)),
			((this.auxCreditClass == null) ? null : (this.auxCreditClass.length() <= auxCreditClassSize) ? this.auxCreditClass : this.auxCreditClass.substring(0, this.auxCreditClassSize)),
			((this.auxAutoLimitInd == null) ? null : (this.auxAutoLimitInd.length() <= auxAutoLimitIndSize) ? this.auxAutoLimitInd : this.auxAutoLimitInd.substring(0, this.auxAutoLimitIndSize)),
			this.auxLmtUpVal,
			this.auxLmtDnVal,
			((this.auxAnalysis1 == null) ? null : (this.auxAnalysis1.length() <= auxAnalysis1Size) ? this.auxAnalysis1 : this.auxAnalysis1.substring(0, this.auxAnalysis1Size)),
			((this.auxAnalysis2 == null) ? null : (this.auxAnalysis2.length() <= auxAnalysis2Size) ? this.auxAnalysis2 : this.auxAnalysis2.substring(0, this.auxAnalysis2Size)),
			((this.auxAnalysis3 == null) ? null : (this.auxAnalysis3.length() <= auxAnalysis3Size) ? this.auxAnalysis3 : this.auxAnalysis3.substring(0, this.auxAnalysis3Size)),
			((this.auxAnalysis4 == null) ? null : (this.auxAnalysis4.length() <= auxAnalysis4Size) ? this.auxAnalysis4 : this.auxAnalysis4.substring(0, this.auxAnalysis4Size)),
			((this.auxAnalysis5 == null) ? null : (this.auxAnalysis5.length() <= auxAnalysis5Size) ? this.auxAnalysis5 : this.auxAnalysis5.substring(0, this.auxAnalysis5Size)),
			((this.auxAnalysis6 == null) ? null : (this.auxAnalysis6.length() <= auxAnalysis6Size) ? this.auxAnalysis6 : this.auxAnalysis6.substring(0, this.auxAnalysis6Size)),
			((this.auxAnalysis7 == null) ? null : (this.auxAnalysis7.length() <= auxAnalysis7Size) ? this.auxAnalysis7 : this.auxAnalysis7.substring(0, this.auxAnalysis7Size)),
			((this.auxAnalysis8 == null) ? null : (this.auxAnalysis8.length() <= auxAnalysis8Size) ? this.auxAnalysis8 : this.auxAnalysis8.substring(0, this.auxAnalysis8Size)),
			((this.auxAnalysis9 == null) ? null : (this.auxAnalysis9.length() <= auxAnalysis9Size) ? this.auxAnalysis9 : this.auxAnalysis9.substring(0, this.auxAnalysis9Size)),
			((this.auxAnalysis10 == null) ? null : (this.auxAnalysis10.length() <= auxAnalysis10Size) ? this.auxAnalysis10 : this.auxAnalysis10.substring(0, this.auxAnalysis10Size)),
			((this.auxAnalysis11 == null) ? null : (this.auxAnalysis11.length() <= auxAnalysis11Size) ? this.auxAnalysis11 : this.auxAnalysis11.substring(0, this.auxAnalysis11Size)),
			((this.auxAnalysis12 == null) ? null : (this.auxAnalysis12.length() <= auxAnalysis12Size) ? this.auxAnalysis12 : this.auxAnalysis12.substring(0, this.auxAnalysis12Size)),
			((this.auxAnalysis13 == null) ? null : (this.auxAnalysis13.length() <= auxAnalysis13Size) ? this.auxAnalysis13 : this.auxAnalysis13.substring(0, this.auxAnalysis13Size)),
			((this.auxAnalysis14 == null) ? null : (this.auxAnalysis14.length() <= auxAnalysis14Size) ? this.auxAnalysis14 : this.auxAnalysis14.substring(0, this.auxAnalysis14Size)),
			((this.auxAnalysis15 == null) ? null : (this.auxAnalysis15.length() <= auxAnalysis15Size) ? this.auxAnalysis15 : this.auxAnalysis15.substring(0, this.auxAnalysis15Size)),
			((this.auxAnalysis16 == null) ? null : (this.auxAnalysis16.length() <= auxAnalysis16Size) ? this.auxAnalysis16 : this.auxAnalysis16.substring(0, this.auxAnalysis16Size)),
			((this.auxAnalysis17 == null) ? null : (this.auxAnalysis17.length() <= auxAnalysis17Size) ? this.auxAnalysis17 : this.auxAnalysis17.substring(0, this.auxAnalysis17Size)),
			((this.auxAnalysis18 == null) ? null : (this.auxAnalysis18.length() <= auxAnalysis18Size) ? this.auxAnalysis18 : this.auxAnalysis18.substring(0, this.auxAnalysis18Size)),
			((this.auxAnalysis19 == null) ? null : (this.auxAnalysis19.length() <= auxAnalysis19Size) ? this.auxAnalysis19 : this.auxAnalysis19.substring(0, this.auxAnalysis19Size)),
			((this.auxAnalysis20 == null) ? null : (this.auxAnalysis20.length() <= auxAnalysis20Size) ? this.auxAnalysis20 : this.auxAnalysis20.substring(0, this.auxAnalysis20Size)),
			((this.auxAnalysis21 == null) ? null : (this.auxAnalysis21.length() <= auxAnalysis21Size) ? this.auxAnalysis21 : this.auxAnalysis21.substring(0, this.auxAnalysis21Size)),
			((this.auxAnalysis22 == null) ? null : (this.auxAnalysis22.length() <= auxAnalysis22Size) ? this.auxAnalysis22 : this.auxAnalysis22.substring(0, this.auxAnalysis22Size)),
			((this.auxAnalysis23 == null) ? null : (this.auxAnalysis23.length() <= auxAnalysis23Size) ? this.auxAnalysis23 : this.auxAnalysis23.substring(0, this.auxAnalysis23Size)),
			((this.auxAnalysis24 == null) ? null : (this.auxAnalysis24.length() <= auxAnalysis24Size) ? this.auxAnalysis24 : this.auxAnalysis24.substring(0, this.auxAnalysis24Size)),
			((this.auxAnalysis25 == null) ? null : (this.auxAnalysis25.length() <= auxAnalysis25Size) ? this.auxAnalysis25 : this.auxAnalysis25.substring(0, this.auxAnalysis25Size)),
			((this.auxAnalysis26 == null) ? null : (this.auxAnalysis26.length() <= auxAnalysis26Size) ? this.auxAnalysis26 : this.auxAnalysis26.substring(0, this.auxAnalysis26Size)),
			((this.auxAnalysis27 == null) ? null : (this.auxAnalysis27.length() <= auxAnalysis27Size) ? this.auxAnalysis27 : this.auxAnalysis27.substring(0, this.auxAnalysis27Size)),
			((this.auxAnalysis28 == null) ? null : (this.auxAnalysis28.length() <= auxAnalysis28Size) ? this.auxAnalysis28 : this.auxAnalysis28.substring(0, this.auxAnalysis28Size)),
			((this.auxAnalysis29 == null) ? null : (this.auxAnalysis29.length() <= auxAnalysis29Size) ? this.auxAnalysis29 : this.auxAnalysis29.substring(0, this.auxAnalysis29Size)),
			((this.auxAnalysis30 == null) ? null : (this.auxAnalysis30.length() <= auxAnalysis30Size) ? this.auxAnalysis30 : this.auxAnalysis30.substring(0, this.auxAnalysis30Size)),
			((this.customer == null) ? null : (this.customer.length() <= customerSize) ? this.customer : this.customer.substring(0, this.customerSize)),
			...
			((this.creditCategory == null) ? null : (this.creditCategory.length() <= creditCategorySize) ? this.creditCategory : this.creditCategory.substring(0, this.creditCategorySize)),
			((this.exportIndicator == null) ? null : (this.exportIndicator.length() <= exportIndicatorSize) ? this.exportIndicator : this.exportIndicator.substring(0, this.exportIndicatorSize)),
			((this.custDiscCode == null) ? null : (this.custDiscCode.length() <= custDiscCodeSize) ? this.custDiscCode : this.custDiscCode.substring(0, this.custDiscCodeSize)),
			((this.currency == null) ? null : (this.currency.length() <= currencySize) ? this.currency : this.currency.substring(0, this.currencySize)),
			((this.territory == null) ? null : (this.territory.length() <= territorySize) ? this.territory : this.territory.substring(0, this.territorySize)),
			((this.klass == null) ? null : (this.klass.length() <= klassSize) ? this.klass : this.klass.substring(0, this.klassSize)),
			((this.region == null) ? null : (this.region.length() <= regionSize) ? this.region : this.region.substring(0, this.regionSize)),
			((this.invoiceCustomer == null) ? null : (this.invoiceCustomer.length() <= invoiceCustomerSize) ? this.invoiceCustomer : this.invoiceCustomer.substring(0, this.invoiceCustomerSize)),
			((this.statementCustomer == null) ? null : (this.statementCustomer.length() <= statementCustomerSize) ? this.statementCustomer : this.statementCustomer.substring(0, this.statementCustomerSize)),
			((this.groupCustomer == null) ? null : (this.groupCustomer.length() <= groupCustomerSize) ? this.groupCustomer : this.groupCustomer.substring(0, this.groupCustomerSize)),
			this.dateLastIssue,
			this.dateCreated,
			...
			((this.analysisCodes4 == null) ? null : (this.analysisCodes4.length() <= analysisCodes4Size) ? this.analysisCodes4 : this.analysisCodes4.substring(0, this.analysisCodes4Size)),
			((this.analysisCodes5 == null) ? null : (this.analysisCodes5.length() <= analysisCodes5Size) ? this.analysisCodes5 : this.analysisCodes5.substring(0, this.analysisCodes5Size)),
			((this.reminderCat == null) ? null : (this.reminderCat.length() <= reminderCatSize) ? this.reminderCat : this.reminderCat.substring(0, this.reminderCatSize)),
			((this.settlementCode == null) ? null : (this.settlementCode.length() <= settlementCodeSize) ? this.settlementCode : this.settlementCode.substring(0, this.settlementCodeSize)),
			((this.settDaysCode == null) ? null : (this.settDaysCode.length() <= settDaysCodeSize) ? this.settDaysCode : this.settDaysCode.substring(0, this.settDaysCodeSize)),
			...
			((this.balanceFwd == null) ? null : (this.balanceFwd.length() <= balanceFwdSize) ? this.balanceFwd : this.balanceFwd.substring(0, this.balanceFwdSize)),
			this.creditLimit,
			this.ytdSales,
			this.ytdCostOfSales,
			this.cumulativeSales,
			this.orderBalance,
			((this.salesNlCat == null) ? null : (this.salesNlCat.length() <= salesNlCatSize) ? this.salesNlCat : this.salesNlCat.substring(0, this.salesNlCatSize)),
			((this.specialPrice == null) ? null : (this.specialPrice.length() <= specialPriceSize) ? this.specialPrice : this.specialPrice.substring(0, this.specialPriceSize)),
			((this.vatRegistration == null) ? null : (this.vatRegistration.length() <= vatRegistrationSize) ? this.vatRegistration : this.vatRegistration.substring(0, this.vatRegistrationSize)),
			((this.directDebit == null) ? null : (this.directDebit.length() <= directDebitSize) ? this.directDebit : this.directDebit.substring(0, this.directDebitSize)),
			((this.invoicesPrinted == null) ? null : (this.invoicesPrinted.length() <= invoicesPrintedSize) ? this.invoicesPrinted : this.invoicesPrinted.substring(0, this.invoicesPrintedSize)),
			((this.consolidatedInv == null) ? null : (this.consolidatedInv.length() <= consolidatedInvSize) ? this.consolidatedInv : this.consolidatedInv.substring(0, this.consolidatedInvSize)),
			((this.commentOnlyInv == null) ? null : (this.commentOnlyInv.length() <= commentOnlyInvSize) ? this.commentOnlyInv : this.commentOnlyInv.substring(0, this.commentOnlyInvSize)),
			((this.bankAccountNo == null) ? null : (this.bankAccountNo.length() <= bankAccountNoSize) ? this.bankAccountNo : this.bankAccountNo.substring(0, this.bankAccountNoSize)),
			((this.bankSortCode == null) ? null : (this.bankSortCode.length() <= bankSortCodeSize) ? this.bankSortCode : this.bankSortCode.substring(0, this.bankSortCodeSize)),
			((this.bankname == null) ? null : (this.bankname.length() <= banknameSize) ? this.bankname : this.bankname.substring(0, this.banknameSize)),
			((this.bankAddress1 == null) ? null : (this.bankAddress1.length() <= bankAddress1Size) ? this.bankAddress1 : this.bankAddress1.substring(0, this.bankAddress1Size)),
			((this.bankAddress2 == null) ? null : (this.bankAddress2.length() <= bankAddress2Size) ? this.bankAddress2 : this.bankAddress2.substring(0, this.bankAddress2Size)),
			((this.bankAddress3 == null) ? null : (this.bankAddress3.length() <= bankAddress3Size) ? this.bankAddress3 : this.bankAddress3.substring(0, this.bankAddress3Size)),
			((this.bankAddress4 == null) ? null : (this.bankAddress4.length() <= bankAddress4Size) ? this.bankAddress4 : this.bankAddress4.substring(0, this.bankAddress4Size)),
			((this.analysisCode6 == null) ? null : (this.analysisCode6.length() <= analysisCode6Size) ? this.analysisCode6 : this.analysisCode6.substring(0, this.analysisCode6Size)),
			((this.produceStatements == null) ? null : (this.produceStatements.length() <= produceStatementsSize) ? this.produceStatements : this.produceStatements.substring(0, this.produceStatementsSize)),
			((this.ediCustomer == null) ? null : (this.ediCustomer.length() <= ediCustomerSize) ? this.ediCustomer : this.ediCustomer.substring(0, this.ediCustomerSize)),
			((this.vatType == null) ? null : (this.vatType.length() <= vatTypeSize) ? this.vatType : this.vatType.substring(0, this.vatTypeSize)),
			((this.language == null) ? null : (this.language.length() <= languageSize) ? this.language : this.language.substring(0, this.languageSize)),
			((this.deliveryMethod == null) ? null : (this.deliveryMethod.length() <= deliveryMethodSize) ? this.deliveryMethod : this.deliveryMethod.substring(0, this.deliveryMethodSize)),
			((this.carrier == null) ? null : (this.carrier.length() <= carrierSize) ? this.carrier : this.carrier.substring(0, this.carrierSize)),
			...
			((this.vatExeNumber == null) ? null : (this.vatExeNumber.length() <= vatExeNumberSize) ? this.vatExeNumber : this.vatExeNumber.substring(0, this.vatExeNumberSize)),
			((this.paydays1 == null) ? null : (this.paydays1.length() <= paydays1Size) ? this.paydays1 : this.paydays1.substring(0, this.paydays1Size)),
			((this.paydays2 == null) ? null : (this.paydays2.length() <= paydays2Size) ? this.paydays2 : this.paydays2.substring(0, this.paydays2Size)),
			((this.paydays3 == null) ? null : (this.paydays3.length() <= paydays3Size) ? this.paydays3 : this.paydays3.substring(0, this.paydays3Size)),
			((this.bankBranchCode == null) ? null : (this.bankBranchCode.length() <= bankBranchCodeSize) ? this.bankBranchCode : this.bankBranchCode.substring(0, this.bankBranchCodeSize)),
			((this.printCpWithStat == null) ? null : (this.printCpWithStat.length() <= printCpWithStatSize) ? this.printCpWithStat : this.printCpWithStat.substring(0, this.printCpWithStatSize)),
			((this.paymentMethod == null) ? null : (this.paymentMethod.length() <= paymentMethodSize) ? this.paymentMethod : this.paymentMethod.substring(0, this.paymentMethodSize)),
			((this.customerClass == null) ? null : (this.customerClass.length() <= customerClassSize) ? this.customerClass : this.customerClass.substring(0, this.customerClassSize)),
			((this.salesType == null) ? null : (this.salesType.length() <= salesTypeSize) ? this.salesType : this.salesType.substring(0, this.salesTypeSize)),
			this.cpLowerValue,
			...
			((this.cpCharge == null) ? null : (this.cpCharge.length() <= cpChargeSize) ? this.cpCharge : this.cpCharge.substring(0, this.cpChargeSize)),
			((this.controlDigit == null) ? null : (this.controlDigit.length() <= controlDigitSize) ? this.controlDigit : this.controlDigit.substring(0, this.controlDigitSize)),
			((this.payer == null) ? null : (this.payer.length() <= payerSize) ? this.payer : this.payer.substring(0, this.payerSize)),
			((this.responsibility == null) ? null : (this.responsibility.length() <= responsibilitySize) ? this.responsibility : this.responsibility.substring(0, this.responsibilitySize)),
			((this.despatchHeld == null) ? null : (this.despatchHeld.length() <= despatchHeldSize) ? this.despatchHeld : this.despatchHeld.substring(0, this.despatchHeldSize)),
			((this.creditController == null) ? null : (this.creditController.length() <= creditControllerSize) ? this.creditController : this.creditController.substring(0, this.creditControllerSize)),
			((this.reminderLetters == null) ? null : (this.reminderLetters.length() <= reminderLettersSize) ? this.reminderLetters : this.reminderLetters.substring(0, this.reminderLettersSize)),
			this.severityDays1,
			this.severityDays2,
			this.severityDays3,
			this.severityDays4,
			this.severityDays5,
			this.severityDays6,
			((this.deliveryReason == null) ? null : (this.deliveryReason.length() <= deliveryReasonSize) ? this.deliveryReason : this.deliveryReason.substring(0, this.deliveryReasonSize)),
			((this.shipperCode1 == null) ? null : (this.shipperCode1.length() <= shipperCode1Size) ? this.shipperCode1 : this.shipperCode1.substring(0, this.shipperCode1Size)),
			((this.shipperCode2 == null) ? null : (this.shipperCode2.length() <= shipperCode2Size) ? this.shipperCode2 : this.shipperCode2.substring(0, this.shipperCode2Size)),
			((this.shipperCode3 == null) ? null : (this.shipperCode3.length() <= shipperCode3Size) ? this.shipperCode3 : this.shipperCode3.substring(0, this.shipperCode3Size)),
			((this.shippingNoteInd == null) ? null : (this.shippingNoteInd.length() <= shippingNoteIndSize) ? this.shippingNoteInd : this.shippingNoteInd.substring(0, this.shippingNoteIndSize)),
			...
			((this.adminFee == null) ? null : (this.adminFee.length() <= adminFeeSize) ? this.adminFee : this.adminFee.substring(0, this.adminFeeSize)),
			((this.intrestRate == null) ? null : (this.intrestRate.length() <= intrestRateSize) ? this.intrestRate : this.intrestRate.substring(0, this.intrestRateSize)),
...
protected DAOArgs primaryKey() {
	return new DAOArgs(2).arg(this.billAcNo).arg(this.sbdSubscriberId); 
}
