...
public class VamVasVsrVstDQO extends DBO implements Serializable {
	...
	public VamVasVsrVstDQO() {
	};

	public VamVasVsrVstDQO(final Integer vamSubscriberId, final String vamSimNo, final String vamMsisdnNo,
			...
			final Integer vasSubscriberId, final String vasServiceCode, final String vasInternTariff,
	...
	private static final int[] fieldSizes = new int[] { 0, vamSimNoSize, vamMsisdnNoSize, 0, vamStatCodeSize, 0, 0,
			...
			vamAnalysis2Size, vamAnalysis3Size, vamAnalysis4Size, vamAnalysis5Size, 0, vasServiceCodeSize,
			vasInternTariffSize, vasServiceTypeSize, 0, 0, vasSubCharge1Size, vasSubCharge2Size, vasSubCharge3Size, 0,
			vasMultiChargeSize, vsrServiceCodeSize, vsrServiceTypeSize, vsrServiceDescSize, vsrOriginatorSize,
