...
public class PshPsdVsrVstDQO extends DBO implements Serializable {
	...
	public PshPsdVsrVstDQO() {
	};

	public PshPsdVsrVstDQO(final Integer pshId, final String pshServiceCode, final String pshServiceType,
	...
	/**
	 * SV To use the deconstruct, a contructer must be create for PsdParamServDetDMO
	 * to accept all input parameter.
	 * 
	 */
...
//	}
	...
	private static final int[] fieldSizes = new int[] { 0, pshServiceCodeSize, pshServiceTypeSize, 0, pshSimNoSize,
			pshMsisdnNoSize, pshArchivedSize, 0, 0, 0, 0, 0, psdParamValueSize, psdN2nStringSize, psdParamActiveSize, 0,
			psdSubChargeSize, 0, psdActTypeSize, 0, vsrServiceCodeSize, vsrServiceTypeSize, vsrServiceDescSize,
			vsrOriginatorSize, vsrServiceClassSize, vsrTempDeactSize, vsrProrataSize, vsrProviderIdSize,
			vsrShortDescSize, vsrSuspendSize, vstServiceTypeSize, vstServiceDescSize, vstMultiChargeSize,
			vstServiceClassSize, vstAutoConnectSize, vstOriginatorSize, vstTariffRelatedSize, vstParameterisedSize,
