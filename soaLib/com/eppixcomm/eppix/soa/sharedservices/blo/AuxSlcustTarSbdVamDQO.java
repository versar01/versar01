...
public class AuxSlcustTarSbdVamDQO extends DBO implements Serializable {

	protected AuxCustomersDMO auxDMO = null;
	protected SlcustmDMO slDMO = null;
	protected TarTransApprovRegDMO tarDMO = null;
	...
	public void deConstruct() {
		...
		auxDMO = new AuxCustomersDMO(auxTitle, auxFirstname, auxInvoiceAddrid, bankName, bankAddr1, bankAddr2,
				...
				auxPrepaidStat, auxCreditClass, auxAutoLimitInd, auxLmtUpVal, auxLmtDnVal, auxAnalysis1, auxAnalysis2,
		...
		slDMO = new SlcustmDMO(customer, alpha, name, address1, address2, address3, address4, address5, creditCategory,
				...
				customerClass, salesType, cpLowerValue, address6, fax, telex, btx, cpCharge, controlDigit, payer,
		...
		tarDMO = new TarTransApprovRegDMO(tarBillAcNo, tarSubscriberId, tarMsisdnNo, tarApprovalLevel, tarChannelType,
				tarChannelValue, tarOverride, tarOverrideUser, tarUserId, tarSystemReq);
	...
	public static final int tarBillAcNoFilter = 176;
	private static final int tarBillAcNoSize = 8;

	public static final int tarSubscriberIdFilter = 177;

	public static final int tarMsisdnNoFilter = 178;
	private static final int tarMsisdnNoSize = 15;

	public static final int tarApprovalLevelFilter = 179;
	private static final int tarApprovalLevelSize = 1;

	public static final int tarChannelTypeFilter = 180;
	private static final int tarChannelTypeSize = 5;

	public static final int tarChannelValueFilter = 181;
	private static final int tarChannelValueSize = 50;

	public static final int tarOverrideFilter = 182;
	private static final int tarOverrideSize = 1;

	public static final int tarOverrideUserFilter = 183;
	private static final int tarOverrideUserSize = 20;

	public static final int tarUserIdFilter = 184;
	private static final int tarUserIdSize = 20;

	public static final int tarSystemReqFilter = 185;
	private static final int tarSystemReqSize = 10;

	public static final int sbdSubscriberIdFilter = 186;

	public static final int sbdDiallingNoFilter = 187;
	private static final int sbdDiallingNoSize = 15;

	public static final int sbdBillAcNoFilter = 188;
	private static final int sbdBillAcNoSize = 8;

	public static final int sbdConnectDateFilter = 189;

	public static final int sbdDconnectDateFilter = 190;

	public static final int sbdTermDateFilter = 191;

	public static final int sbdTitleFilter = 192;
	private static final int sbdTitleSize = 10;

	public static final int sbdSurnameFilter = 193;
	private static final int sbdSurnameSize = 50;

	public static final int sbdFirstnameFilter = 194;
	private static final int sbdFirstnameSize = 50;

	public static final int sbdGenderFilter = 195;
	private static final int sbdGenderSize = 1;

	public static final int sbdDobFilter = 196;

	public static final int sbdPasswordFilter = 197;
	private static final int sbdPasswordSize = 20;

	public static final int sbdLocationCodeFilter = 198;
	private static final int sbdLocationCodeSize = 15;

	public static final int sbdBillCycleFilter = 199;
	private static final int sbdBillCycleSize = 5;

	public static final int sbdPackageCodeFilter = 200;
	private static final int sbdPackageCodeSize = 5;

	public static final int sbdBilledUptoFilter = 201;

	public static final int sbdTariffPlanFilter = 202;
	private static final int sbdTariffPlanSize = 20;

	public static final int vamSubscriberIdFilter = 203;

	public static final int vamSimNoFilter = 204;
	private static final int vamSimNoSize = 14;

	public static final int vamMsisdnNoFilter = 205;
	private static final int vamMsisdnNoSize = 15;

	public static final int vamTwinbillNoFilter = 206;

	public static final int vamStatCodeFilter = 207;
	private static final int vamStatCodeSize = 2;

	public static final int vamConnectDateFilter = 208;

	public static final int vamDconnectDateFilter = 209;

	public static final int vamInternTariffFilter = 210;
	private static final int vamInternTariffSize = 20;

	public static final int vamContrTerminatFilter = 211;

	public static final int vamContrPeriodFilter = 212;

	public static final int vamTerminatNotifFilter = 213;

	public static final int vamDirEntryFilter = 214;
	private static final int vamDirEntrySize = 1;

	public static final int vamItemisedFilter = 215;
	private static final int vamItemisedSize = 1;

	public static final int vamDepartmentFilter = 216;
	private static final int vamDepartmentSize = 3;

	public static final int vamSalesmanFilter = 217;
	private static final int vamSalesmanSize = 10;

	public static final int vamDealerIdFilter = 218;
	private static final int vamDealerIdSize = 8;

	public static final int vamAbarDateFilter = 219;

	public static final int vamSubsSuffixFilter = 220;
	private static final int vamSubsSuffixSize = 1;

	public static final int vamMessCommentFilter = 221;
	private static final int vamMessCommentSize = 20;

	public static final int vamAirtimeNetFilter = 222;
	private static final int vamAirtimeNetSize = 1;

	public static final int vamPrFlagFilter = 223;
	private static final int vamPrFlagSize = 1;

	public static final int vamHierarchyFilter = 224;
	private static final int vamHierarchySize = 1;

	public static final int vamMsisdnKnownFilter = 225;
	private static final int vamMsisdnKnownSize = 1;

	public static final int vamTariffChgFilter = 226;

	public static final int vamOrigProvIdFilter = 227;
	private static final int vamOrigProvIdSize = 5;

	public static final int vamImpProvIdFilter = 228;
	private static final int vamImpProvIdSize = 5;

	public static final int vamOrigServProvFilter = 229;
	private static final int vamOrigServProvSize = 5;

	public static final int vamImpServProvFilter = 230;
	private static final int vamImpServProvSize = 5;

	public static final int vamMsisdnTypeFilter = 231;
	private static final int vamMsisdnTypeSize = 50;

	public static final int vamDummyFilter = 232;
	private static final int vamDummySize = 1;

	public static final int vamMsisdnExprtdFilter = 233;

	public static final int vamExportedToFilter = 234;
	private static final int vamExportedToSize = 5;

	public static final int vamAnalysis1Filter = 235;
	private static final int vamAnalysis1Size = 30;

	public static final int vamAnalysis2Filter = 236;
	private static final int vamAnalysis2Size = 30;

	public static final int vamAnalysis3Filter = 237;
	private static final int vamAnalysis3Size = 30;

	public static final int vamAnalysis4Filter = 238;
	private static final int vamAnalysis4Size = 30;

	public static final int vamAnalysis5Filter = 239;
	private static final int vamAnalysis5Size = 30;

	public AuxSlcustTarSbdVamDQO() {
	};

	public AuxSlcustTarSbdVamDQO(final String auxTitle, final String auxFirstname, final Integer auxInvoiceAddrid,
			...
			final String printCpWithStat, final String paymentMethod, final String customerClass,
			...
			final String accountType, final String adminFee, final String intrestRate, final String tarBillAcNo,
			final Integer tarSubscriberId, final String tarMsisdnNo, final String tarApprovalLevel,
			final String tarChannelType, final String tarChannelValue, final String tarOverride,
			final String tarOverrideUser, final String tarUserId, final String tarSystemReq,
			...
			final Integer vamSubscriberId, final String vamSimNo, final String vamMsisdnNo, final Short vamTwinbillNo,
			final String vamStatCode, final Date vamConnectDate, final Date vamDconnectDate,
	...
	private static final int[] fieldSizes = new int[] { auxTitleSize, auxFirstnameSize, 0, bankNnameSize, bankAddr1Size,
			...
			printCpWithStatSize, paymentMethodSize, customerClassSize, salesTypeSize, 0, address6Size, faxSize,
			...
			shipperCode2Size, shipperCode3Size, shippingNoteIndSize, accountTypeSize, adminFeeSize, intrestRateSize,
			tarBillAcNoSize, 0, tarMsisdnNoSize, tarApprovalLevelSize, tarChannelTypeSize, tarChannelValueSize,
			tarOverrideSize, tarOverrideUserSize, tarUserIdSize, tarSystemReqSize, 0, sbdDiallingNoSize,
			sbdBillAcNoSize, 0, 0, 0, sbdTitleSize, sbdSurnameSize, sbdFirstnameSize, sbdGenderSize, 0, sbdPasswordSize,
			sbdLocationCodeSize, sbdBillCycleSize, sbdPackageCodeSize, 0, sbdTariffPlanSize, 0, vamSimNoSize,
			...
			vamExportedToSize, vamAnalysis1Size, vamAnalysis2Size, vamAnalysis3Size, vamAnalysis4Size,
			vamAnalysis5Size };
	...
	protected Object[] get() {
		return new Object[] {
				...
				((this.customerClass == null) ? null
						: (this.customerClass.length() <= customerClassSize) ? this.customerClass
								: this.customerClass.substring(0, this.customerClassSize)),
	...
	protected void set(Object[] fields) {
		...
		this.tarBillAcNo = rtrim((String) fields[176]);
		this.tarSubscriberId = ((Integer) fields[177]);
		this.tarMsisdnNo = rtrim((String) fields[178]);
		this.tarApprovalLevel = rtrim((String) fields[179]);
		this.tarChannelType = rtrim((String) fields[180]);
		this.tarChannelValue = rtrim((String) fields[181]);
		this.tarOverride = rtrim((String) fields[182]);
		this.tarOverrideUser = rtrim((String) fields[183]);
		this.tarUserId = rtrim((String) fields[184]);
		this.tarSystemReq = rtrim((String) fields[185]);
		this.sbdSubscriberId = ((Integer) fields[186]);
		this.sbdDiallingNo = rtrim((String) fields[187]);
		this.sbdBillAcNo = rtrim((String) fields[188]);
		this.sbdConnectDate = ((fields[189] == null) ? null : new Date(fields[189]));
		this.sbdDconnectDate = ((fields[190] == null) ? null : new Date(fields[190]));
		this.sbdTermDate = ((fields[191] == null) ? null : new Date(fields[191]));
		this.sbdTitle = rtrim((String) fields[192]);
		this.sbdSurname = rtrim((String) fields[193]);
		this.sbdFirstname = rtrim((String) fields[194]);
		this.sbdGender = rtrim((String) fields[195]);
		this.sbdDob = ((fields[196] == null) ? null : new Date(fields[196]));
		this.sbdPassword = rtrim((String) fields[197]);
		this.sbdLocationCode = rtrim((String) fields[198]);
		this.sbdBillCycle = rtrim((String) fields[199]);
		this.sbdPackageCode = rtrim((String) fields[200]);
		this.sbdBilledUpto = ((fields[201] == null) ? null : new Date(fields[201]));
		this.sbdTariffPlan = rtrim((String) fields[202]);
		this.vamSubscriberId = ((Integer) fields[203]);
		this.vamSimNo = rtrim((String) fields[204]);
		this.vamMsisdnNo = rtrim((String) fields[205]);
		this.vamTwinbillNo = ((Short) fields[206]);
		this.vamStatCode = rtrim((String) fields[207]);
		this.vamConnectDate = ((fields[208] == null) ? null : new Date(fields[208]));
		this.vamDconnectDate = ((fields[209] == null) ? null : new Date(fields[209]));
		this.vamInternTariff = rtrim((String) fields[210]);
		this.vamContrTerminat = ((fields[211] == null) ? null : new Date(fields[211]));
		this.vamContrPeriod = ((Short) fields[212]);
		this.vamTerminatNotif = ((fields[213] == null) ? null : new Date(fields[213]));
		this.vamDirEntry = rtrim((String) fields[214]);
		this.vamItemised = rtrim((String) fields[215]);
		this.vamDepartment = rtrim((String) fields[216]);
		this.vamSalesman = rtrim((String) fields[217]);
		this.vamDealerId = rtrim((String) fields[218]);
		this.vamAbarDate = ((fields[219] == null) ? null : new Date(fields[219]));
		this.vamSubsSuffix = rtrim((String) fields[220]);
		this.vamMessComment = rtrim((String) fields[221]);
		this.vamAirtimeNet = rtrim((String) fields[222]);
		this.vamPrFlag = rtrim((String) fields[223]);
		this.vamHierarchy = rtrim((String) fields[224]);
		this.vamMsisdnKnown = rtrim((String) fields[225]);
		this.vamTariffChg = ((fields[226] == null) ? null : new Date(fields[226]));
		this.vamOrigProvId = rtrim((String) fields[227]);
		this.vamImpProvId = rtrim((String) fields[228]);
		this.vamOrigServProv = rtrim((String) fields[229]);
		this.vamImpServProv = rtrim((String) fields[230]);
		this.vamMsisdnType = rtrim((String) fields[231]);
		this.vamDummy = rtrim((String) fields[232]);
		this.vamMsisdnExprtd = ((fields[233] == null) ? null : new Date(fields[233]));
		this.vamExportedTo = rtrim((String) fields[234]);
		this.vamAnalysis1 = rtrim((String) fields[235]);
		this.vamAnalysis2 = rtrim((String) fields[236]);
		this.vamAnalysis3 = rtrim((String) fields[237]);
		this.vamAnalysis4 = rtrim((String) fields[238]);
		this.vamAnalysis5 = rtrim((String) fields[239]);
	}
	...
	public TarTransApprovRegDMO getTarDMO() {
		return tarDMO;
	}

	public void setTarDMO(TarTransApprovRegDMO tarDMO) {
		this.tarDMO = tarDMO;
	}
