...
public class VasVamDQO extends DBO implements Serializable {
	...
	public VasVamDQO(final Integer vasSubscriberId,
	...
	private static final int[] fieldSizes = new int[] { 0, vasServiceCodeSize,
			...
			vamAnalysis3Size, vamAnalysis4Size, vamAnalysis5Size };
	...
	protected void set(Object[] fields) {
		...
		this.vasActDate = ((fields[4] == null) ? null : new Date(
				 fields[4]));
		this.vasDeactDate = ((fields[5] == null) ? null : new Date(
				 fields[5]));
		...
		this.vamAbarDate = ((fields[27] == null) ? null : new Date(
				 fields[27]));
		...
		this.vamTariffChg = ((fields[34] == null) ? null : new Date(
				 fields[34]));
	...
	public String toString() {
		return "\nVasVamDQO [\nvasDMO=" + vasDMO + ", vamDMO=" + vamDMO
				+ ", vasSubscriberId=" + vasSubscriberId + ", vasServiceCode="
				+ vasServiceCode + ", vasInternTariff=" + vasInternTariff
				+ ", vasServiceType=" + vasServiceType + ", vasActDate="
				+ vasActDate + ", vasDeactDate=" + vasDeactDate
				+ ", vasSubCharge1=" + vasSubCharge1 + ", vasSubCharge2="
				+ vasSubCharge2 + ", vasSubCharge3=" + vasSubCharge3
				+ ", vasTwinbillNo=" + vasTwinbillNo + ", vasMultiCharge="
				+ vasMultiCharge + ", vamSubscriberId=" + vamSubscriberId
				+ ", vamSimNo=" + vamSimNo + ", vamMsisdnNo=" + vamMsisdnNo
				+ ", vamTwinbillNo=" + vamTwinbillNo + ", vamStatCode="
				+ vamStatCode + ", vamConnectDate=" + vamConnectDate
				+ ", vamDconnectDate=" + vamDconnectDate + ", vamInternTariff="
				+ vamInternTariff + ", vamContrTerminat=" + vamContrTerminat
