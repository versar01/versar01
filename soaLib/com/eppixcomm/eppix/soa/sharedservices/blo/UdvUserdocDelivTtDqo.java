...
public class UdvUserdocDelivTtDqo extends DBO implements Serializable {
	...
	private String ttText1;
	private String ttText2;
	private String ttText3;
	private String ttText4;
	...
	public static final int ttText1Filter = 14;
	private static final int ttText1Size = 50;

	public static final int ttText2Filter = 15;
	private static final int ttText2Size = 50;

	public static final int ttText3Filter = 16;
	private static final int ttText3Size = 50;

	public static final int ttText4Filter = 17;
	private static final int ttText4Size = 50;

	public UdvUserdocDelivTtDqo() {
	};

	public UdvUserdocDelivTtDqo(final String udvBillAcNo, final Integer udvSubscriberId, final String udvDocType,
			final String udvDelivery, final String udvFormat, final String udvAddressType, final Short udvFrequency,
			final String udvSuspend, final Date udvDateSuspended, final Date udvSuspendUpto, final Short udvPeriodCount,
			final String udvPrintArrears, final Date udvLastIssued, final Date udvLastPdcount, final String ttText1,
			final String ttText2, final String ttText3, final String ttText4) {
		...
		this.ttText1 = ttText1;
		this.ttText2 = ttText2;
		this.ttText3 = ttText3;
		this.ttText4 = ttText4;
	};

	private static final int[] fieldSizes = new int[] { udvBillAcNoSize, 0, udvDocTypeSize, udvDeliverySize,
			udvFormatSize, udvAddressTypeSize, 0, udvSuspendSize, 0, 0, 0, udvPrintArrearsSize, 0, 0, ttText1Size,
			ttText2Size, ttText3Size, ttText4Size };

	private static final int[] fieldTypes = new int[] { FIELD_TYPE_STRING, FIELD_TYPE_INTEGER, FIELD_TYPE_STRING,
			FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_STRING, FIELD_TYPE_SHORT, FIELD_TYPE_STRING,
			FIELD_TYPE_DATE, FIELD_TYPE_DATE, FIELD_TYPE_SHORT, FIELD_TYPE_STRING, FIELD_TYPE_DATE, FIELD_TYPE_DATE,
		...
		return new Object[] {
				((this.udvBillAcNo == null) ? null
						: (this.udvBillAcNo.length() <= udvBillAcNoSize) ? this.udvBillAcNo
								: this.udvBillAcNo.substring(0, this.udvBillAcNoSize)),
				this.udvSubscriberId,
				((this.udvDocType == null) ? null
						: (this.udvDocType.length() <= udvDocTypeSize) ? this.udvDocType
								: this.udvDocType.substring(0, this.udvDocTypeSize)),
				((this.udvDelivery == null) ? null
						: (this.udvDelivery.length() <= udvDeliverySize) ? this.udvDelivery
								: this.udvDelivery.substring(0, this.udvDeliverySize)),
				((this.udvFormat == null) ? null
						: (this.udvFormat.length() <= udvFormatSize) ? this.udvFormat
								: this.udvFormat.substring(0, this.udvFormatSize)),
				((this.udvAddressType == null) ? null
						: (this.udvAddressType.length() <= udvAddressTypeSize) ? this.udvAddressType
								: this.udvAddressType.substring(0, this.udvAddressTypeSize)),
				this.udvFrequency,
				((this.udvSuspend == null) ? null
						: (this.udvSuspend.length() <= udvSuspendSize) ? this.udvSuspend
								: this.udvSuspend.substring(0, this.udvSuspendSize)),
				this.udvDateSuspended, this.udvSuspendUpto, this.udvPeriodCount,
				((this.udvPrintArrears == null) ? null
						: (this.udvPrintArrears.length() <= udvPrintArrearsSize) ? this.udvPrintArrears
								: this.udvPrintArrears.substring(0, this.udvPrintArrearsSize)),
				this.udvLastIssued, this.udvLastPdcount,
				((this.ttText1 == null) ? null
						: (this.ttText1.length() <= ttText1Size) ? this.ttText1
								: this.ttText1.substring(0, this.ttText1Size)),
				((this.ttText2 == null) ? null
						: (this.ttText2.length() <= ttText2Size) ? this.ttText2
								: this.ttText2.substring(0, this.ttText2Size)),
				((this.ttText3 == null) ? null
						: (this.ttText3.length() <= ttText3Size) ? this.ttText3
								: this.ttText3.substring(0, this.ttText3Size)),
				((this.ttText4 == null) ? null
						: (this.ttText4.length() <= ttText4Size) ? this.ttText4
								: this.ttText4.substring(0, this.ttText4Size)) };
	}
	...
	protected void set(Object[] fields) {
		...
		this.ttText1 = rtrim((String) fields[14]);
		this.ttText2 = rtrim((String) fields[15]);
		this.ttText3 = rtrim((String) fields[16]);
		this.ttText4 = rtrim((String) fields[17]);
	}

	public void set(final String udvBillAcNo, final Integer udvSubscriberId, final String udvDocType,
			final String udvDelivery, final String udvFormat, final String udvAddressType, final Short udvFrequency,
			final String udvSuspend, final Date udvDateSuspended, final Date udvSuspendUpto, final Short udvPeriodCount,
			final String udvPrintArrears, final Date udvLastIssued, final Date udvLastPdcount, final String ttText1,
			final String ttText2, final String ttText3, final String ttText4) {
	...
	public String getTtText1() {
		return ttText1;
	}

	public void setTtText1(String ttText1) {
		this.ttText1 = ttText1;
	}

	public String getTtText2() {
		return ttText2;
	}

	public void setTtText2(String ttText2) {
		this.ttText2 = ttText2;
	}

	public String getTtText3() {
		return ttText3;
	}

	public void setTtText3(String ttText3) {
		this.ttText3 = ttText3;
	}

	public String getTtText4() {
		return ttText4;
	}

	public void setTtText4(String ttText4) {
		this.ttText4 = ttText4;
	}
