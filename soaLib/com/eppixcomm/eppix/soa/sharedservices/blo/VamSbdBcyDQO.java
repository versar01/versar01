...
public class VamSbdBcyDQO extends DBO implements Serializable {

	private VamActiveMsisdnDMO vamDMO;
	private SbdSubDetsDMO sbdDMO;
	private BcyBillingCycleDMO bcyDMO;
	...
	public static final int bcyBillCycleFilter = 54;
	private static final int bcyBillCycleSize = 5;

	public static final int bcyDescriptionFilter = 55;
	private static final int bcyDescriptionSize = 30;

	public static final int bcyPeriodFilter = 56;
	private static final int bcyPeriodSize = 1;

	public static final int bcyFrequencyFilter = 57;

	public static final int bcyDayOfRunFilter = 58;

	public static final int bcyNextRunFilter = 59;

	public static final int bcySuspendedFilter = 60;
	private static final int bcySuspendedSize = 1;

	public static final int bcyUseStatusFilter = 61;
	private static final int bcyUseStatusSize = 1;

	public static final int bcyNextCallRunFilter = 62;

	public static final int bcyInAdvanceFilter = 63;
	private static final int bcyInAdvanceSize = 1;

	public VamSbdBcyDQO() {
	};

	public VamSbdBcyDQO(final Integer vamSubscriberId, final String vamSimNo,
			...
			final String vamAnalysis5, final Integer sbdSubscriberId,
			...
			final String bcyBillCycle, final String bcyDescription,
	...
	private static final int[] fieldSizes = new int[] { 0, vamSimNoSize,
			...
			vamAnalysis4Size, vamAnalysis5Size, 0, sbdDiallingNoSize,
			...
			sbdTariffPlanSize, bcyBillCycleSize, bcyDescriptionSize,
			bcyPeriodSize, 0, 0, 0, bcySuspendedSize, bcyUseStatusSize, 0,
			bcyInAdvanceSize };
	...
	protected void deConstruct() {
		...
		sbdDMO = new SbdSubDetsDMO(sbdSubscriberId, sbdDiallingNo, sbdBillAcNo,
				...
				sbdTariffPlan);
		bcyDMO = new BcyBillingCycleDMO(bcyBillCycle, bcyDescription,
				bcyPeriod, bcyFrequency, bcyDayOfRun, bcyNextRun, bcySuspended,
				bcyUseStatus, bcyNextCallRun, bcyInAdvance);
	...
	protected void set(Object[] fields) {
		...
		this.sbdConnectDate = ((fields[40] == null) ? null : new Date(
				 fields[40]));
		this.sbdDconnectDate = ((fields[41] == null) ? null : new Date(
				 fields[41]));
		this.sbdTermDate = ((fields[42] == null) ? null : new Date(
				 fields[42]));
		...
		this.sbdDob = ((fields[47] == null) ? null
				: new Date( fields[47]));
		...
		this.sbdBilledUpto = ((fields[52] == null) ? null : new Date(
				 fields[52]));
		this.sbdTariffPlan = rtrim((String) fields[53]);
		this.bcyBillCycle = rtrim((String) fields[54]);
		this.bcyDescription = rtrim((String) fields[55]);
		this.bcyPeriod = rtrim((String) fields[56]);
		this.bcyFrequency = ((Short) fields[57]);
		this.bcyDayOfRun = ((Short) fields[58]);
		this.bcyNextRun = ((fields[59] == null) ? null : new Date(
				 fields[59]));
		this.bcySuspended = rtrim((String) fields[60]);
		this.bcyUseStatus = rtrim((String) fields[61]);
		this.bcyNextCallRun = ((fields[62] == null) ? null : new Date(
				 fields[62]));
		this.bcyInAdvance = rtrim((String) fields[63]);
	}
	...
	public BcyBillingCycleDMO getBcyDMO() {
		return bcyDMO;
	}

	public void setBcyDMO(BcyBillingCycleDMO bcyDMO) {
		this.bcyDMO = bcyDMO;
	}
	...
	public String toString() {
		return "\nVamSbdBcyDQO [\nvamDMO=" + vamDMO + "\nsbdDMO=" + sbdDMO
				...
				+ sbdSubscriberId + "\nsbdDiallingNo=" + sbdDiallingNo
				+ "\nsbdBillAcNo=" + sbdBillAcNo + "\nsbdConnectDate="
				+ sbdConnectDate + "\nsbdDconnectDate=" + sbdDconnectDate
				+ "\nsbdTermDate=" + sbdTermDate + "\nsbdTitle=" + sbdTitle
				+ "\nsbdSurname=" + sbdSurname + "\nsbdFirstname="
				+ sbdFirstname + "\nsbdGender=" + sbdGender + "\nsbdDob="
				+ sbdDob + "\nsbdPassword=" + sbdPassword
				+ "\nsbdLocationCode=" + sbdLocationCode + "\nsbdBillCycle="
				+ sbdBillCycle + "\nsbdPackageCode=" + sbdPackageCode
				+ "\nsbdBilledUpto=" + sbdBilledUpto + "\nsbdTariffPlan="
				+ sbdTariffPlan + "\nbcyBillCycle=" + bcyBillCycle
				+ "\nbcyDescription=" + bcyDescription + "\nbcyPeriod="
				+ bcyPeriod + "\nbcyFrequency=" + bcyFrequency
				+ "\nbcyDayOfRun=" + bcyDayOfRun + "\nbcyNextRun=" + bcyNextRun
				+ "\nbcySuspended=" + bcySuspended + "\nbcyUseStatus="
				+ bcyUseStatus + "\nbcyNextCallRun=" + bcyNextCallRun
				+ "\nbcyInAdvance=" + bcyInAdvance + "]";
	}
